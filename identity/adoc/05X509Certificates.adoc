...
The Maritime Cloud *Production* environment root certificates in http://developers.maritimecloud.net/identity/prod-certificate/mc-ca-chain.pem[PEM] or http://developers.maritimecloud.net/identity/prod-certificate/mc-truststore-password-is-changeit.jks[JKS] format.

//The Maritime Cloud *Staging* environment root certificates in http://developers.maritimecloud.net/identity/staging-certificate/mc-ca-chain.pem[PEM] or http://developers.maritimecloud.net/identity/staging-certificate/mc-truststore-password-is-changeit.jks[JKS] format.

The Maritime Cloud *Test* environment root certificates in http://developers.maritimecloud.net/identity/test-certificate/mc-ca-chain.pem[PEM] or http://developers.maritimecloud.net/identity/test-certificate/mc-truststore-password-is-changeit.jks[JKS] format.
