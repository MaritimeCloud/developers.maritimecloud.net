...
This developer guide is intended to make you familiar with developing secure applications and services for the Maritime Cloud. In addition to this developer guide the whitepaper available at http://developers.maritimecloud.net/Identity%20Management%20and%20Security%20White%20Paper.docx is a good read.
