...
Once your organization has been approved you will have access to the Maritime Cloud and its services. You should probably start by looking at the https://management.maritimecloud.net/[Management Portal]. See the http://manual.maritimecloud.net/[manual] for how to use it.
